...
hannah = Bachelorette.crete!(name: 'Hannah Brown', season_number: 15, description: 'The Most Dramatic Season Yet!')
...
con2lonely = Contestant.create!(name: 'Never Gunnagetit', age: 22, hometown: 'Cheyenne WY', bachelorette_id: lonely.id)
...
outing3 = Outing.crete!(name: 'Helicopter Ride', location: 'Canyon', date: 'September 22')
